...
webservice.use((0, _compression2.default)()).use((0, _methodOverride2.default)()).use((0, _multer2.default)().array()).use((0, _bodyParser.urlencoded)({ extended: true })).use((0, _bodyParser.json)()).use(_filterHelper2.default).use(_router2.default);
